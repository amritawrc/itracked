...
<!--                                                    <input type="radio" name="lisence" value="yes" id="radio_yes"> Yes-->
...
<!--                                                </div>-->
<!--                                            </div>-->
<!--                                            <div class="col-md-5" id="make_payment_button">-->
<!--                                                <button type="submit" class="btn default" name="submit">Make Payment</button> -->
<!--                                            </div>-->
...
<script>
    ...
    return this.optional(element) || /^[_a-z0-9-]+(\.[_a-z0-9-]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.[a-z]{2,3})$/i.test(value);
        ...
        $("#myfrm").validate({
            ...
            //         email: true,
            //         remote: {
            //             url: BASE_URL + 'manageorg/email_id_check/',
            //             type: "post",
            //             data: {
            //                 email_id: function () {
            //                     return $('#email').val();
            ...
            messages: {
                ...
                phno: {
                    ...
                    maxlength: "<font color=\"red\">Phone number must be less than 20 digits</font> ",
                },
                mobno: {
    ...
    //               email: "<font color=\"red\">only emails are accepted</font> ",
		  ...
		  // emailRegex:"<font color=\"red\">Email format not correct</font>"
    //             },
                website: {
