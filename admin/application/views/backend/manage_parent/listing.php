...
<!--                                                 <td><?php echo $value['name'];?></td>-->
                                            	<td style="width: 20%"><?php echo $value['fname'];?></td>
...
<!--                                                   <button aria-expanded="false" data-toggle="dropdown" type="button" class="btn btn-xs green dropdown-toggle">View </button>-->
                                                   ...
                                                   <a href="<?php echo base_url() . 'managepar/delete_par/';?><?php echo base64_encode($value['id']);?>" class="btn btn-xs green dropdown-toggle">Delete </a>
