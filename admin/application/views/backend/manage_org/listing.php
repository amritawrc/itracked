										...
										?>
                                            <tr class="odd gradeX">
                                              ...
                                              <!--  <td><?php echo $value['phone'];?></td> -->
                                                ...
                                                <td width="180px">
                                                    <a href="<?php echo base_url() . 'manageorg/view/';?><?php echo base64_encode($value['org_seq_no']).'/'; ?><?php echo base64_encode($value['add_seq_no']);?>"  class="btn btn-xs green dropdown-toggle"> View</a>
                                                   <a href="<?php echo base_url() . 'manageorg/edit/';?><?php echo base64_encode($value['org_seq_no']).'/'; ?><?php echo base64_encode($value['add_seq_no']);?>"  class="btn btn-xs green dropdown-toggle"> Edit</a>
                                                
                                                   <a href="<?php echo base_url() . 'manageorg/delete/';?><?php echo base64_encode($value['org_seq_no']).'/'; ?><?php echo base64_encode($value['add_seq_no']);?>" class="btn btn-xs green dropdown-toggle">Delete </a>
