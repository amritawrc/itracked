                                ...
                                <form class="form-horizontal" method="post" id="myfrm" action="<?php echo $base_url; ?>manageorg/edit/<?php echo base64_encode($det[0]['org_seq_no']).'/'; ?><?php echo base64_encode($det[0]['add_seq_no']); ?>">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" placeholder="Enter name" class="form-control spinner" name="orgname" disabled = "disabled" id="orgname" value="<?php echo $det[0]['org_name'];?>"> </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" disabled = "disabled" placeholder="Enter Phone No." class="form-control spinner" name="phno" id="phno" value="<?php echo $det[0]['phone'];?>"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Mobile Number</label>
                                            <div class="col-md-9">
                                                <input type="text" disabled = "disabled" placeholder="Enter Mobile No." class="form-control spinner" name="mobno" id="mobno" value="<?php echo $det[0]['mobile_cell'];?>"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Email</label>
                                            <div class="col-md-9">
                                                <input type="email" disabled = "disabled" placeholder="Enter email" class="form-control spinner" name="email" id="email" value="<?php echo $det[0]['email'];?>"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Website</label>
                                            <div class="col-md-9">
                                                <input type="text" placeholder="Enter website" class="form-control spinner" name="website" id="website" disabled = "disabled" value="<?php echo $det[0]['website_url'];?>"></div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" disabled = "disabled" placeholder="Enter address house name/number" class="form-control spinner" name="house" id="house" value="<?php echo $det[0]['house_name_number'];?>"></div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Address street Name</label>
                                            <div class="col-md-9">
                                                <input type="text" disabled = "disabled" placeholder="Enter street name" class="form-control spinner" name="street" id="street" value="<?php echo $det[0]['street_name'];?>"></div>
                                        </div>
                                        <!--                                            <div class="form-group">
...
<!--                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" placeholder="Enter postal code" class="form-control spinner" name="postal" id="postal" disabled = "disabled" value="<?php echo $det[0]['postal_code'];?>">
                                            </div>    
                                        </div>
                                        <div class="form-group">
...
<!--                                                    <input type="text" placeholder="Enter type of organization" class="form-control spinner" >-->
                                                <select class="form-control spinner" name="type" id="type" disabled = "disabled">
<!--                                                    <input type="text"  class="form-control spinner" ></div>-->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" placeholder="Enter organization authorization no." class="form-control spinner" name="authno" id="authno" disabled = "disabled" value="<?php echo $det[0]['org_auth_no'];?>"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Emergency Contact Name </label>
                                            <div class="col-md-9">
                                                <input type="text" placeholder="Enter emergency contact name" class="form-control spinner" name="emgname" id="emgname" disabled = "disabled" value="<?php echo $det[0]['sp_contact_name'];?>"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Emergency contact person role </label>
                                            <div class="col-md-9">
                                                <input type="text" placeholder="Enter emergency contact person role" class="form-control spinner" name="role" id="role" disabled = "disabled" value="<?php echo $det[0]['sp_contact_role'];?>"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Emergency contact primary number </label>
                                            <div class="col-md-9">
                                                <input type="text" placeholder="Enter emergency contact primary number" class="form-control spinner" name="primary" id="primary" disabled = "disabled" value="<?php echo $det[0]['sp_contact_no1'];?>"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Emergency contact secondary number </label>
                                            <div class="col-md-9">
                                                <input type="text" placeholder="Enter emergency contact secondary number" class="form-control spinner" name="secondary" id="secondary" disabled = "disabled" value="<?php echo $det[0]['sp_contact_no2'];?>"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Emergency contact tertiary number </label>
                                            <div class="col-md-9">
                                                <input type="text" placeholder="Enter emergency contact tertiary number" class="form-control spinner" name="tertiary" id="tertiary" disabled = "disabled" value="<?php echo $det[0]['sp_contact_no3'];?>"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Registration Start Date</label>
                                            <div class="col-md-9">
                                                <input class="form-control form-control-inline input-medium date-picker" disabled = "disabled" type="text" placeholder="Enter start date" name="start_date" id="start_date" value="<?php echo $det[0]['reg_start_date'];?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control form-control-inline input-medium date-picker" disabled = "disabled" type="text" placeholder="Enter end date" name="end_date" id="end_date" value="<?php echo $det[0]['reg_end_date'];?>">
...
<!--                                                        <input type="checkbox" id="inlineCheckbox1" value="yes" name="lisence"> Yes -->
                                                    <input type="radio" name="lisence" disabled = "disabled" value="yes" <?php if($det[0]['lisence_fee_paid'] == "yes") echo 'checked';?>> Yes
  
                                                    </label>
                                                    <label class="checkbox-inline">
<!--                                                        <input type="checkbox" id="inlineCheckbox2" value="no" name="lisence"> No -->
                                                     <input type="radio" name="lisence" disabled = "disabled" value="no"  <?php if($det[0]['lisence_fee_paid'] == "no") echo 'checked';?>> No</label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <textarea class="form-control spinner" name="remarks" id="remarks" disabled="disabled"><?php echo $det[0]['remarks_notes'];?></textarea></div>
                                        </div>
