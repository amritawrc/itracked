    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <div class="portlet-body">
                        	<h3 class="page-title">View List Of  Paying Students
                    </h3>
...
<!--                                                <th style="width: 30%"> Organization Name </th>-->
                                                ...
                                                <th style="width: 20%">Student Address</th>
                                                <th>Phone No.</th>
                                                <th>Email</th>
                                                <th>Date</th>
                                               <th>Where</th>
										...
										?>
                                            <tr class="odd gradeX">
<!--                                                <td class="center"><?php echo $value['org_name'];?> </td>-->
                                                ...
                                                <td class="center"><?php echo $value['email'];?> </td>
                                                 ...
                                                 <td class="center"><?php echo $value['ven_name'];?> </td>
                                            </tr>
