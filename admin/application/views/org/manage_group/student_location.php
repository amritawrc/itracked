...
<?php foreach ($details as $k => $v) { ?>
                ['<?php echo $v['first_name'] ?>', '<?php echo $v['last_name'] ?>', <?php echo $v['age_on_return_to_uk'] ?>, <?php echo $v['lat']; ?>, <?php echo $v['long']; ?>, '<?php echo $v['email']; ?>', '<?php echo $v['phone']; ?>', '<?php echo $v['event_name']; ?>', '<?php echo $v['instructor_first_name']; ?>', '<?php echo $v['instructor_last_name']; ?>'],
<?php } ?>
        ];
...
?>),
        ...
        setInterval(function () {
            var group_id = "<?php echo $grp_id; ?>";
            $.ajax({
                type: "POST",
                url: BASE_URL + "managegroup/groupMap1/" + group_id,
                data: {},
