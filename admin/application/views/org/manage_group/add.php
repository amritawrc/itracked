                    ...
                    <?php } ?>
                        ...
                        <div class="portlet box purple ">
                            ...
                            <div class="portlet-body form">
                                       ...
                                       <form class="form-horizontal" method="post" id="myfrm" action="<?php echo $base_url; ?>managegroup/add/">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" placeholder="Enter group name" class="form-control spinner" name="group_name" id="group_name"> </div>
                                        </div>
                                         <div class="form-group">
                                            <label class="col-md-3 control-label">Group Owner Name</label>
                                            <div class="col-md-9">
                                             <input type="text" placeholder="Enter group owner name" class="form-control spinner" name="owner_name" id="owner_name">
                                        ...
                                        <div class="form-group">
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                               <input  type="text" class="form-control spinner timepicker timepicker-24 " name="training_time_start" id="training_time_start">
	                                        </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input  type="text" class="form-control spinner timepicker timepicker-24 spinner" name="training_time_end" id="training_time_end">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <select class="form-control spinner" name="training_for" id="training_for">
                                                    ...
                                                    <option value='3'>During Session</option>
