...
<!--                                                   <button aria-expanded="false" data-toggle="dropdown" type="button" class="btn btn-xs green dropdown-toggle">View </button>-->
                                                   ...
                                                   <a href="<?php echo base_url() . 'org/managevenue/delete/';?><?php echo base64_encode($value['ven_seq_no']).'/'; ?><?php echo base64_encode($value['add_seq_no']);?>" class="btn btn-xs green dropdown-toggle">Delete </a>
