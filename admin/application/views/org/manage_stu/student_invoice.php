                                ...
                                <form class="form-horizontal" method="post" id="myfrm" action="<?php echo $base_url; ?>dashboard/edit/">
                                    <div class="form-body">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <label class="col-md-3 control-label"><?php echo $det[0]['txnid'];?></label>

                                            </div>
                                        </div>
                                     
                                      <div class="form-group">
                                            <label class="col-md-3 control-label">Tocken</label>
                                            <div class="col-md-9">
                                                <label class="col-md-3 control-label"><?php echo $det[0]['tocken'];?></label>
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <label class="col-md-3 control-label"><?php echo $det[0]['payment_amount'];?></label>
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <label class="col-md-3 control-label"><?php echo $det[0]['payment_status'];?></label>

                                            </div>
                                        </div>    
                                        
                                                     <div class="form-group">
                                            <label class="col-md-3 control-label">Payment Date And Time</label>
                                            <div class="col-md-9">
                                                <label class="col-md-3 control-label"><?php echo $det[0]['createdtime'];?></label>
                                        ...
                                        <div style="width: 100%; height: 35px; text-align: right; display:inline-block; ">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <a href="<?php echo $base_url; ?>managestu/index"><button type="button" class="btn green">Back</button></a>
                                            </div>
                                        </div>
