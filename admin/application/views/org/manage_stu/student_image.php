            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="organization_form">
                        <h3 class="page-title">Student Image
                        </h3>
                            ...
                            <div class="portlet-body form">
                                <form class="form-horizontal" method="post" id="myfrm" action="<?php echo $base_url; ?>dashboard/edit/">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <label class="col-md-3 control-label"><img src="<?php echo base_url(); ?>assets/upload/student_panic_image/<?php echo $det[0]['image'];?>" width="200" height="200"></label>
