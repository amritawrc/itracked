            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="organization_form">
                        <h3 class="page-title">Student Registration
                        </h3>
                        ...
                        <div class="portlet box purple ">
                            ...
                            <div class="portlet-body form">
                                ...
                                <form class="form-horizontal" method="post" id="myfrm" action="<?php echo $base_url; ?>managestu/add/">
                                    <div class="form-body">
...
<!--                                                        <input type="checkbox" id="inlineCheckbox2" value="no" name="lisence"> No -->
                                                        <input type="radio" name="gender" value="Felame"> Female</label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control form-control-inline input-medium date-picker" type="text" placeholder="Enter date of birth" name="dob" id="dob">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" placeholder="Enter age" class="form-control spinner" name="age" id="age">
                                            </div>    
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <div class="checkbox-list">
                                                    <label class="checkbox-inline">
<!--                                                        <input type="checkbox" id="inlineCheckbox1" value="yes" name="lisence"> Yes -->
                                                        <input type="radio" name="ski" value="1" id="skii" checked onclick="show_cont();"> Ski excursions

                                                    </label>
                                                    <label class="checkbox-inline">
<!--                                                        <input type="checkbox" id="inlineCheckbox2" value="no" name="lisence"> No -->
                                                        <input type="radio" name="ski" id="out" value="2" onclick="show_con();"> Outdoor excursions</label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group" id="heightt">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" placeholder="Enter height" class="form-control spinner" name="height" id="height">
                                            </div>    
                                        </div>
                                        <div class="form-group" id="weightt">
                                            <label class="col-md-3 control-label">Weight</label>
                                            <div class="col-md-9">
                                                <input type="text" placeholder="Enter weight" class="form-control spinner" name="weight" id="weight">
                                            </div>    
                                        </div>
                                        <div class="form-group" id="shoee">
                                            <label class="col-md-3 control-label">Shoe Size</label>
                                            <div class="col-md-9">
                                                <input type="text" placeholder="Enter shoe size" class="form-control spinner" name="shoe" id="shoe">
                                            </div>    
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Remarks</label>
                                            <div class="col-md-9">
                                                <textarea placeholder="" class="form-control spinner" name="remarks" id="remarks"></textarea></div>
                                        </div>
                                        ...
                                        <div class="form-group" id="medd">
                                            ...
                                            <div class="col-md-9">
                                                <div class="checkbox-list">
                                                    <label class="checkbox-inline">
<!--                                                        <input type="checkbox" id="inlineCheckbox1" value="yes" name="lisence"> Yes -->
                                                        <input type="radio" name="med" value="1"> Yes
                                        ...
                                        <div class="form-group" id="diett">
                                            ...
                                            <div class="col-md-9">
                                                <div class="checkbox-list">
                                                    <label class="checkbox-inline">
<!--                                                        <input type="checkbox" id="inlineCheckbox1" value="yes" name="lisence"> Yes -->
                                                        <input type="radio" name="diet" value="1"> Yes
