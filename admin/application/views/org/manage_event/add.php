                    ...
                    <?php } ?>
                        ...
                        <div class="portlet box purple ">
                            ...
                            <div class="portlet-body form">
                                       ...
                                       <form class="form-horizontal" method="post" id="myfrm" action="<?php echo $base_url; ?>manageevent/add/">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" placeholder="Enter event name" class="form-control spinner" name="event_name" id="event_name"> </div>
                                        </div>
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                 <select class="form-control spinner" name="venue_name" id="venue_name">
                                                    ...
                                                    <?php foreach ($ven as $key => $value) { ?>
                                                        <option value='<?php echo $value['ven_seq_no']; ?>'><?php echo $value['ven_name']." "; ?></option>
                                                    <?php }
                                                    ?>
                                                </select>
...
<!--                                        <div class="form-group">
                                ...
                                <select class="form-control1 spinner" multiple="multiple" id="ms" name="stud[]">
                                    ...
                                    <?php foreach ($grp as $key => $value) { ?>
                                     <option value="<?php echo $value['group_seq_no']; ?>"><?php echo $value['group_name']; ?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control form-control-inline input-medium" type="text" placeholder="Enter cost" name="cost" id="cost">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <div class="checkbox-list">
                                                    ...
                                                    <input type="radio" name="dis" id="yes" value="yes" checked onclick="show_cont();"> Yes
  
                                                    </label>
                                                    <label class="checkbox-inline">

                                                     <input type="radio" name="dis" id="no" value="no" onclick="show_con();"> No</label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group" id="aa">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" placeholder="Enter discount" class="form-control spinner" name="discount" id="discount">
                                            </div>    
                                        </div>
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" placeholder="Enter age" class="form-control spinner" name="minage" id="minage">
                                            </div>    
                                        </div>
                                          <div class="form-group" id="weightt">
                                            <label class="col-md-3 control-label">Max Age</label>
                                            <div class="col-md-9">
                                                <input type="text" placeholder="Enter age" class="form-control spinner" name="maxage" id="maxage">
                                            </div>    
                                        </div>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" placeholder="Enter start meeting point" class="form-control spinner" name="smeeting" id="smeeting">
                                        </div>  
                                          </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" placeholder="Enter end meeting point" class="form-control spinner" name="emeeting" id="emeeting">
                                            </div>
                                        </div>
