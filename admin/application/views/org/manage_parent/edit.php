            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="organization_form">
                        <h3 class="page-title">Parent Edit
                        </h3>
                    ...
                    <?php } ?>
                        ...
                        <div class="portlet box purple ">
                            ...
                            <div class="portlet-body form">
                                      ...
                                      <form class="form-horizontal" method="post" id="myfrm" action="<?php echo $base_url; ?>manageparent/edit/<?php echo base64_encode($det[0]['par_seq_no']).'/'; ?><?php echo base64_encode($det[0]['add_seq_no']); ?>">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" placeholder="Enter first name" class="form-control spinner" name="f_first_name" id="f_first_name" value="<?php echo $det[0]['fath_first_name'];?>"> </div>
                                                  <input type="hidden" name="org" value="<?php echo base64_encode($det[0]['add_seq_no']); ?>">
                                             <input type="hidden" name="idd" value="<?php echo base64_encode($det[0]['par_seq_no']); ?>">
                                        </div>
                                         <div class="form-group">
                                            <label class="col-md-3 control-label">Father Last Name</label>
                                            <div class="col-md-9">
                                                <input type="text" placeholder="Enter last name" class="form-control spinner" name="f_last_name" id="f_last_name" value="<?php echo $det[0]['fath_last_name'];?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" placeholder="Enter first name" class="form-control spinner" name="m_first_name" id="m_first_name" value="<?php echo $det[0]['mot_first_name'];?>"> </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Mother Last Name</label>
                                            <div class="col-md-9">
                                                <input type="text" placeholder="Enter last name" class="form-control spinner" name="m_last_name" id="m_last_name" value="<?php echo $det[0]['mot_last_name'];?>"> </div>
                                        </div>
                                        <div class="form-group">
...
<!--                                                    <input type="text"  class="form-control spinner" ></div>-->
                                        ...
                                        <div class="form-group">
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" placeholder="Enter no. of children" class="form-control spinner" name="child" id="child" value="<?php echo $det[0]['no_child'];?>">
                                            </div>    
                                        </div>
                                        <div class="form-group">
